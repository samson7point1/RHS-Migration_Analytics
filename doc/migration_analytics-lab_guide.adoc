...
- You can use the same instructions to delete the profile later on when you have finished with the labu can use the same instructions to delete the profile later on when you have finished with the lab
